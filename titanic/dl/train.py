...
def main():
    ...
    print(X_train.shape)
    model = dense_net(input_shape=(X_train.shape[1], ), layer_dims=(150,), activation='relu', dropout_rate=0.2)
    model.summary()

    tensorboard = tf.keras.callbacks.TensorBoard('./dl/logs', update_freq=1)
